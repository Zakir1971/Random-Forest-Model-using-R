...
##sleep quality model
load("/Users/Cindy/Downloads/e4sleepdata/Final sleep quality models.RData")

##feeling refreshed model
load("/Users/Cindy/Downloads/e4sleepdata/Final feeling refreshed models.RData")

########### load test data
# The address of E4 data
root="/Users/Cindy/Downloads/Dec 19 Jan 20 zipfiles/";
numberPerson = 1
numberWeek = 4
numberDay = 7
...
library(R.matlab)
options(matlab = "/Applications/MATLAB_R2019a.app/bin/matlab")
Matlab$startServer()
matlab <- Matlab()
isOpen <- open(matlab)
print(matlab)
